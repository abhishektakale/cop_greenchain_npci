...
# second step of the EYFN tutorial. It joins the bank3 peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.bank3.
#
...
infoln "Joining bank3 peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for bank3..."
setAnchorPeer 3

successln "Channel '$CHANNEL_NAME' joined"
successln "bank3 peer successfully added to network"
